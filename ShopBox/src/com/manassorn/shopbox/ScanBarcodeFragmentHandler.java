...
import com.manassorn.shopbox.barcode.DecodeThread;
 ...
 */
public final class ScanBarcodeFragmentHandler extends Handler {

	private static final String TAG = ScanBarcodeFragmentHandler.class.getSimpleName();

	private final ScanBarcodeFragment activity;
	...
	ScanBarcodeFragmentHandler(ScanBarcodeFragment activity,
			Collection<BarcodeFormat> decodeFormats, Map<DecodeHintType, ?> baseHints,
			String characterSet, CameraManager cameraManager) {
		this.activity = activity;
		decodeThread = new DecodeThread(this, cameraManager, decodeFormats, baseHints,
				characterSet, null);
		decodeThread.start();
		state = State.SUCCESS;
